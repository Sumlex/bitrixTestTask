...
<div class="sb_sidebar">
					...
					<div class="sb_action">
						<a href=""><img src="<?=SITE_TEMPLATE_PATH?> /bitrix/templates/.default/content/11.png" alt=""/></a>
						<h4>Акция</h4>
						<h5><a href="">Мебельная полка всего за 560 Р</a></h5>
						<a href="" class="sb_action_more">Подробнее &rarr;</a>
					</div>
					<div class="sb_reviewed">
							<img src="<?=SITE_TEMPLATE_PATH?> /bitrix/templates/.default/content/8.png" class="sb_rw_avatar" alt=""/>
